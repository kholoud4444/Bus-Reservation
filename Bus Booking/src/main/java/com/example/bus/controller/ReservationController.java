...
public class ReservationController {
    ...
    public ResponseEntity<List<Reservation>> viewReservationByUser(@RequestParam(required = false) Integer key) {

        List<Reservation> reservationList = (List<Reservation>) reservationService.viewReservationByUser(key);
